...
public class SourceDigestService {
    ...
    private final DigestContextTrimmer contentTrimmer;
    ...
    public SourceDigestService(
            ...
            DigestContextTrimmer contentTrimmer
    ) {
    ...
    public SourceDigestResult digest(SourceDigestInput input) {
        DigestContextTrimmer.Result trimmed = contentTrimmer.trim(input.content());
