...
public class BusinessException extends RuntimeException {
    ...
    public BusinessException(com.swimming.backend.agentwork.exception.AgentWorkErrorCode errorCode) {
        this(errorCode, errorCode.getStatus(), errorCode.getMessage(), errorCode.name(), null);
    }
    ...
    public BusinessException(com.swimming.backend.agentwork.exception.AgentWorkErrorCode errorCode, Throwable cause) {
        this(errorCode, errorCode.getStatus(), errorCode.getMessage(), errorCode.name(), cause);
    }
