...
<section class="hero hero--clipped">
  <div class="hero__copy">
    ...
    <p>The folder tracker your engineering team won't ignore.</p>
...
**Example.** A Linear-style SaaS landing for a folder tracker. Headline left ("Plan, build, ship."), browser-frame screenshot of the kanban view right, tilted 1.5° clockwise. Three numbered annotations (1 · assigns automatically · 2 · real-time presence · 3 · keyboard-first), each with a small numbered pin and a margin-aligned caption — never arrows-and-labels. Single screenshot, not a stack — fewer assets to load, sharper read.
...
<header class="hero hero--rail">
  ...
  <div class="hero__body">
    ...
    <p class="hero__lede">Twelve years. Selected folders, in their own time.</p>
  </div>
</header>
```
```css
