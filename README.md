...
| --- | --- | --- |
| 떠오른 생각은 메모로, 다시 볼 자료는 링크로 먼저 남깁니다. | AI의 제안을 확인하고 다음 할 일을 고릅니다. | 공간과 시간을 선택하고, 한 가지 일에 집중한 기록을 남깁니다. |

이 흐름에는 네 가지 원칙이 있습니다.

- **수집할 때 판단하지 않기** — 생각을 놓치지 않는 것이 먼저입니다.
- **결정을 한 번에 하나씩 하기** — AI는 할 일을 제안하고 선택은 사용자가 합니다.
- **다음 행동만 선명하게 보기** — 오늘 시작할 일을 먼저 계획합니다.
