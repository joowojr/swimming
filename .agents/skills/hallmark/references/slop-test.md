...
| **F** | **Variety** | Does this output share a structural fingerprint with a previous Hallmark output in the folder? Score by structural distance, not visual distance — colour-swaps don't count as variety. |
