...
| **Overlapping image** | Heading layered atop photography or colour block. Demands strong contrast. | Pentagram folder pages; Manifesto posters. |
...
2. **Anti-repetition.** Across consecutive pages built in the same sessionEntity, no two should share more than three of the six axes. If the previous page used left-margin headings + single column + hairline divider + outlined button, this page should differ on at least three of those.
...
| **agency, studio (work-led), case studies, multi-folder portfolio, freelance creative** | **Portfolio Grid** · **Split Studio** · **Index-First** |
