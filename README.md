...
설치 없이 실제 서비스를 열거나, 직접 만든 Arcade 데모를 따라가며 Swimming의 주요 흐름을 먼저 살펴볼 수 있습니다.

<p align="center">
  <a href="https://swimming-now.kro.kr"><strong>Swimming 서비스 열기 ↗</strong></a>
  &nbsp;&nbsp;·&nbsp;&nbsp;
  <a href="https://demo.arcade.software/6hc0sGlWpaQYxIBWfmkF"><strong> 인터랙티브 데모 보기 ↗</strong></a>
</p>
...
| --- | --- | --- |
| 떠오른 생각은 메모로, 다시 볼 자료는 링크로 먼저 남깁니다. | AI의 제안을 확인하고 폴더·데일리 플랜·매트릭스에서 다음 행동을 고릅니다. | 공간과 시간을 선택하고, 한 가지 일에 집중한 기록을 남깁니다. |

이 흐름에는 네 가지 원칙이 있습니다.

- **수집할 때 판단하지 않기** — 생각을 놓치지 않는 것이 먼저입니다.
- **결정을 한 번에 하나씩 하기** — AI는 후보를 제안하고 최종 선택은 사용자가 합니다.
- **다음 행동만 선명하게 보기** — 전체 분량보다 오늘 시작할 일을 앞에 둡니다.
- **해낸 것을 축적하기** — 압박형 경고 대신 완료와 집중 기록을 보여 줍니다.
