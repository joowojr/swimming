...
final class RemoteWorkerCertificationTestData {
    ...
    static List<TaskOrganizerTestScenario> scenarios() {
        FolderContext certification = folder(
                201L,
                "정보처리기사 준비",
        ...
        return List.of(
                scenario(
                        ...
                        "자격증 공부와 집안일이 섞인 메모",
                        "정보처리기사 이론 정리는 Folder에 분류하고 빨래와 분리수거는 다듬은 미분류 항목으로 남기는지 평가",
                        """
                ...
                scenario(
                        ...
                        "대상 자료나 자격증 단서가 없는 정리·문제 풀이를 유일한 Folder에 강제 배정하지 않고 미분류하는지 평가",
                ...
                scenario(
                        ...
                        "자격증 공부 축약어와 구어체",
                        "정처기·기출·오답이라는 축약 표현을 정보처리기사 Folder와 기존 Task 맥락에 연결하는지 평가",
                ...
                scenario(
                        ...
                        "유일한 자격증 Folder와 무관한 회사 업무",
                        "재택근무 중 처리할 회사 업무를 정보처리기사 Folder에 강제 배정하지 않고 다듬은 미분류 항목으로 남기는지 평가",
                        "내일 오전 팀 주간회의 자료 숫자 최신걸로 바꾸고 민지님한테 슬랙 보내기",
                        List.of(certification),
                        certificationTasks
                ),
                scenario(
                        "remote-worker-no-folders",
                        "Folder 정보가 없는 저녁 메모",
                        "Folder가 없을 때 공부와 집안일 행동을 각각 원문 보존된 미분류 항목으로 다듬는지 평가",
                        "퇴근하고 네트워크 기출 열문제 풀기\n택배 온거 경비실에서 찾아오기",
                        List.of(),
                        List.of()
                ),
                ...
                scenario(
                        ...
                        "기존 Task 문맥으로 Folder 판단",
                        "Folder 이름 없이 틀린 기출과 해설 키워드를 기존 기출·오답 Task 묶음으로 읽어 정보처리기사에 분류하는지 평가",
